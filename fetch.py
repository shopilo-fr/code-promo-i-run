#!/usr/bin/env python3
"""
Recuperation des codes promo i-Run depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/i-run.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/i-run.fr"
STORE_NAME = "i-Run"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour i-Run depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-i-run)"
    }
    try:
